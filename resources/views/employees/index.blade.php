...
<div class="col-md-12">
 <div class="card">
     <div class="card-body">
       <div class="row">
       <div class="col-sm-12">
         <h3 class="card-title mb-2">الموظفين</h3>
       </div>
       ...
       <div class="col-6 mt-2" dir="ltr">
         <a href="{{ route('add', ['view' => 'employees.add']) }}" style="padding: 3px 15px;" type="button" class="btn btn-success text-white ">
           اضافة موظف &nbsp;<i class="mdi mdi-account-plus font-18"></i>
         </a>
       </div>
      </div>
     </div>
