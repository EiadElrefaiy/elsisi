                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4" dir="ltr">
                                  <span style="padding: 5px 15px; font-size: 18px;" class="badge bg-warning">متبقي له</span>
                                </div>
                                ...
                                <div class="col-md-4">
                                  <div class="form-group row">
                                      <label
                                          for="lname"
                                          class="col-sm-3 text-end control-label col-form-label">حالة الفاتورة</label>
                                      <div class="col-md-9">
                                        <select
                                          class="select2 form-select shadow-none"
                                          style="width: 100%; height: 36px">
                                        <option>مكتمل</option>
                                        <option>متبقي له</option>
                                        </select>
                                      </div>
                                    </div> 
                              </div>
                    ...
                    <div class="col-md-12">
                      ...
                      <div class="col-md-8">
                          <div class="form-group row">
                            <label
                                for="lname"
                                class="font-18">المتبقي : 120000 ج</label>
                        </div>                   
                      </div>
                     </div>
                    </div>
